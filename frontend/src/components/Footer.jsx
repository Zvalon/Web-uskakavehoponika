      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-10 mb-12 pb-12 border-b border-parchment/10">
          <div className="flex items-center gap-5">
            <img src={logoSrc} alt="U skákavého poníka" className="h-16 opacity-90 brightness-0 invert" />
            <div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <a href="#" className="font-body text-[11px] tracking-widest uppercase text-parchment/30 hover:text-parchment/70 transition-colors">Instagram</a>
            <a href="#" className="font-body text-[11px] tracking-widest uppercase text-parchment/30 hover:text-parchment/70 transition-colors">Facebook</a>
          </div>
        </div>
      </div>
    </footer>
